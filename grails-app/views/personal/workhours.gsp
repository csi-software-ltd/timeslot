...
<g:timepicker class="normal nopad" style="margin-right:68px" name="workhours_time_open" value="${workhours?String.format('%tH:%<tM',workhours?.time_open):'09:00'}" interval="${interval}" />
...
<div class="fright">
  ...
  <input type="reset" class="button" value="Отмена" onclick="jQuery('#workhoursAddForm').slideUp();"/>
</div>
