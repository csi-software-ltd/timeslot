    ...
    <g:javascript>
      function processResponse(e){
        ...
        if(e.responseJSON.errorcode.length){
          ...
          location.assign('${createLink(controller:'company', action:'index', params:[linkname:partner.linkname])}');
      }
    </g:javascript>
  </head>
  <body>
    ...
    <div class="grid_6 padtop">
      ...
      <g:formRemote style="${!restore_user?'display:none':''}" name="prestoreForm" url="${[controller:'company', action:'passrest', params:[linkname:partner.linkname]]}" method="post" autocomplete='off' onSuccess="processResponse(e)">
