<html>
  ...
  <body>
    ...
    <div class="grid_6 padtop">
      ...
      <g:formRemote name="restoreForm" url="${[controller:'company', action:'rest', params:[linkname:partner.linkname]]}" method="post" autocomplete='off' onSuccess="processResponse(e)">
